...
#INIT PARAMS
PATH_OUTPUT = "output/"
model_name = 'model_base_bert_0.2_1e-4_256_dim_v2'
torch.manual_seed(1)
print(model_name)
...
model=BertTransformer(vocab_size =INPUT_SIZE, d_model=256, nhead=4, num_encoder_layers=4, dim_feedforward=2048, max_seq_length=20, device=device)
model.to(device)
